...
class HTMLParser(_markupbase.ParserBase):
    ...
    def parse_starttag(self, i):
        ...
        while k < endpos:
            ...
            if not rest:
                attrvalue = None
            elif not (attrvalue[:1] == "'" and "'" == attrvalue[-1:]):
                if attrvalue[:1] == '"':
                    pass
            else:
    ...
    def unescape(self, s):
        warnings.warn('The unescape method is deprecated and will be removed in 3.5, use html.unescape() instead.', DeprecationWarning, stacklevel=2)
        return unescape(s)
