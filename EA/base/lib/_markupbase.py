...
class ParserBase:
    ...
    def parse_declaration(self, i):
        ...
        while j < n:
            ...
            if c in '"\'':
                ...
                elif decltype in frozenset({'linktype', 'element', 'attlist', 'link'}):
    ...
    def parse_marked_section(self, i, report=1):
        ...
        if j < 0:
            return j
        if sectName in frozenset({'cdata', 'temp', 'rcdata', 'ignore', 'include'}):
            match = _markedsectionclose.search(rawdata, i + 3)
        elif sectName in frozenset({'endif', 'else', 'if'}):
            ...
            if c == '<':
                ...
                if rawdata[j:j + 4] == '<!--':
                    ...
                    if j < 0:
                        ...
                        if j == -1:
                            return -1
                        if name not in frozenset({'notation', 'element', 'attlist', 'entity'}):
