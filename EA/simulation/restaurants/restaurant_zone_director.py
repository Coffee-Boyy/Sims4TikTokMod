...
class RestaurantZoneDirector(CustomerAndEmployeeZoneDirectorMixin, VisitorSituationOnArrivalZoneDirectorMixin, SchedulingZoneDirector):
    ...
    def create_situations_during_zone_spin_up(self):
        ...
        for situation_shift in self.situation_shifts:
            ...
            if time_span is not None:
                self.situation_shifts.handle_situation_shift_churn(situation_shift, reserve_object_relationships=True)
    ...
    def get_group_order(self, sim_id:'int', create_if_not_found=True) -> 'Optional[GroupOrder]':
    ...
    def get_group_order_by_id(self, group_order_id:'int') -> 'Optional[GroupOrder]':
        if group_order_id in self._group_orders:
            return self._group_orders[group_order_id]
