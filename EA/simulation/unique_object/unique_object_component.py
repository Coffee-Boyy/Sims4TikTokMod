    ...
    def handle_event(self, _, event:'TestEvent', resolver):
        ...
        if event == TestEvent.StoredSimInfoComponentAdded:
            ...
            if not from_load:
                ...
                unique_object_service = services.unique_object_service()
                unique_object_service.mark_household_inventory_for_enforcement()
                unique_object_service.enforce_uniqueness_across_active_zone()
