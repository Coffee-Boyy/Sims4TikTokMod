                    ...
                    for career in career_tracker:
                        ...
                        if gig is None:
                            ...
                            if not customer_zone_id is None:
                                ...
                                services.get_event_manager().process_event(test_events.TestEvent.SimoleonsEarnedBB, simoleon_data_type=SimoleonData.TotalMoneyEarned, amount=amount, custom_keys=(household_id,))
                            elif amount < 0:
