...
class PickType(enum.Int):
    ...
    PICK_CLUB_PANEL = 18
    PICK_CEILING = 19
    PICK_MANAGE_SMALL_BUSINESS_OUTFIT = -3
...
class PickInfo:
    ...
    def get_zone_id_from_pick_location(self, ignore_shared_plex=True):
        lot_id = self.lot_id
        if lot_id is None:
            return
        ...
        return persistence_service.resolve_lot_id_into_zone_id(lot_id, ignore_neighborhood_id=self._ignore_neighborhood_id, ignore_shared_plex=ignore_shared_plex)
