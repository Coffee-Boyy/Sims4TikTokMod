...
class SmallBusinessEmployeeManager(BusinessEmployeeManager):
    ...
    def add_employee(self, sim_info:SimInfo, employee_type:BusinessEmployeeType, is_npc_employee:bool=False):
        ...
        owner_info = services.sim_info_manager().get(self._owner_id)
        services.get_event_manager().process_event(TestEvent.SmallBusinessEmployeeHired, sim_info=owner_info, target_sim_id=self._owner_id)
