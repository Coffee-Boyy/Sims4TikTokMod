...
def print_scoring_info(_connection=None):
    ...
    for node_type in dnm.types.values():
        if node_type.scoring is None:
            ...
            if not node_type.sender_sim_info.type == DramaNodeParticipantOption.DRAMA_PARTICIPANT_OPTION_FILTER:
                if node_type.sender_sim_info.type == DramaNodeParticipantOption.DRAMA_PARTICIPANT_OPTION_MATCHING_FILTER:
