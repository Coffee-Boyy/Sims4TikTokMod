...
@sims4.commands.Command('clock.setgametime', command_type=CommandType.Automation)
...
def send_clock_telemetry_data(_connection):
    ...
    if household is not None:
        ...
        if new_speed != previous_speed:
            with telemetry_helper.begin_hook(clock_telemetry_writer, TELEMETRY_HOOK_CHANGE_SPEED_GAME, household=household) as hook:
