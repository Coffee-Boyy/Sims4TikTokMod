import operatorimport randomfrom sims4.localization import TunableLocalizedStringfrom sims4.tuning.instances import HashedTunedInstanceMetaclassfrom sims4.tuning.tunable import Tunable, TunableResourceKey, TunableEnumEntry, TunableTuple, TunableInterval, OptionalTunablefrom sims4.tuning.tunable_base import ExportModesfrom sims4.utils import classproperty, flexmethodfrom statistics.base_statistic import BaseStatistic, GalleryLoadBehaviorfrom statistics.tunable import TunableStatAsmParamimport servicesimport sims4.resources
class Statistic(BaseStatistic, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.STATISTIC)):
    ...
    @flexmethod
    def get_raw_value(cls, inst) -> float:
        if inst is not None:
            return inst._value
        else:
            return cls.default_value
