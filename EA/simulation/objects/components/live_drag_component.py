...
class LiveDragComponent(NativeComponent, HasTunableFactory, component_name=LIVE_DRAG_COMPONENT, key=2125782609):
    ...
    @distributor.fields.ComponentField(op=distributor.ops.SetCanLiveDrag, default=False)
    ...
    @property
    def is_ending_drag(self) -> bool:
        return self._is_ending_drag

    @is_ending_drag.setter
    def is_ending_drag(self, value:bool):
        self._is_ending_drag = value
