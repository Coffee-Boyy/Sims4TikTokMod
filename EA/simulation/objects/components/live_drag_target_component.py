...
class LiveDragTargetComponent(Component, HasTunableFactory, AutoFactoryInit, component_name=LIVE_DRAG_TARGET_COMPONENT):
    ...
    def test_live_drag(self, live_drag_obj:'GameObject') -> 'Tuple[bool, Optional[Any]]':
        ...
        if inventoryitem_component.unique and (can_add_to_inventory or (inventoryitem_component.unique_exclusion_list is None or self.owner.inventory_component is None) or self.owner.inventory_component.inventory_type not in inventoryitem_component.unique_exclusion_list):
