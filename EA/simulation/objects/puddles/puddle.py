...
class Puddle(objects.game_object.GameObject):
    ...
    def place_puddle(self, target, max_distance, ids_to_ignore=DEFAULT, offset=None):
        destroy_puddle = True
        try:
            ...
            if routing_surface is None:
                ...
                if position is not None:
                    ...
                    if offset is not None:
                        ...
                        right = Vector3(forward.z*-1, forward.y, forward.x)
                        position += forward*offset.forward + right*offset.right
