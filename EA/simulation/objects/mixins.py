...
class InstancedSuperAffordanceProviderMixin(SuperAffordanceProviderMixin):
...
class TargetSuperAffordanceProviderMixin:
    INSTANCE_TUNABLES = {'target_super_affordances': TunableProvidedAffordances(description='\n            Super affordances this adds to the target.\n            ', class_restrictions=('SuperInteraction',), locked_args={'target': ParticipantType.Object, 'carry_target': ParticipantType.Invalid, 'is_linked': False, 'unlink_if_running': False})}
    FACTORY_TUNABLES = INSTANCE_TUNABLES
