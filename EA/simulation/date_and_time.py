...
class DateAndTime(int):
    ...
    def absolute_ticks(self):
        ticks = int(self)
        if ticks > sims4.math.MAX_UINT64:
            logger.warn('absolute ticks value over max uint64 value. Needs to be clamped before passing to protobuf.')
        return ticks
