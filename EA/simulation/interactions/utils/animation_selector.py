...
class TunableAnimationSelector(TunableFactory):
    ...
    def __new__(cls, *args, interaction_asm_type=DEFAULT, override_animation_context=False, participant_enum_override=DEFAULT, **kwargs):
        key = (interaction_asm_type, override_animation_context, participant_enum_override)
        if key in cls._intern_cache:
            return cls._intern_cache[key]
        instance = super().__new__(cls)
        cls._intern_cache[key] = instance
