...
class InteractionInstanceManager(InstanceManager):
    ...
    def on_packs_loaded(self) -> None:
        ...
        self.repopulate_animation_constraint_cache()

    def create_class_instances(self, *args, **kwargs) -> None:
        super().create_class_instances(*args, **kwargs)
        if BUILD_AC_CACHE:
    ...
    def _use_animation_constraint_cache(self):
        ...
        for cls in self.types.values():
            ...
            if cls._auto_constraints is None and cached_constraints:
                valid_constraints = {}
    ...
    def repopulate_animation_constraint_cache(self) -> None:
        self.purge_cache()
        self._use_animation_constraint_cache()
