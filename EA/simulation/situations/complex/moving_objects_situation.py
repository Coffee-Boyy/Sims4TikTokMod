...
class MovingObjectsSituation(SituationComplexCommon):
    ...
    def _move_objects(self):
        ...
        for object_to_move in objects_to_move:
            ...
            if self.vfx_after_move:
                in_sequence.append(lambda _, object_to_move=object_to_move: self.vfx_after_move(object_to_move).start_one_shot())
        sequence = []
        if out_sequence:
