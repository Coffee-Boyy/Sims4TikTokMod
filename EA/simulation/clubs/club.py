...
class Club:
    ...
    def add_rule(self, rule):
        ...
        if rule.is_encouraged:
            ...
            static_commodity_data = SituationStaticCommodityData(self.discouragement_commodity, 1)
        for affordance in rule.action():
