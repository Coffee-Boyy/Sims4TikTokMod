...
@sims4.commands.Command('live_events.on_rewards_claimed', command_type=sims4.commands.CommandType.Live)
def on_rewards_claimed(_connection=None):
    account_reward_globals.increment_account_reward_cache_version()
