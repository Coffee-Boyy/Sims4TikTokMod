    ...
    def picker_rows_gen(cls, inst, target, context, **kwargs):
        ...
        with adoption_service.real_sim_info_cache():
            for entry in inst_or_cls.picker_entries:
                for sim_info in adoption_service.get_sim_infos(entry.count, entry.creation_data.age, entry.creation_data.gender, entry.creation_data.species, entry.creation_data.traits, entry.creation_data.adoption_type):
