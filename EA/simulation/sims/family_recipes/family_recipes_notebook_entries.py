    ...
    def get_definition_notebook_data(self, ingredient_cache:'list'=[]) -> 'Optional[EntryData]':
        ...
        if family_recipes_tracker is None:
            ...
            if existing_family_recipe:
                ...
                return EntryData(recipe_name, None, IconInfoData(obj_def_id=self.final_product.id), self._get_entry_tooltip(self.final_product), row_display, self.entry_sublist_is_sortable)
