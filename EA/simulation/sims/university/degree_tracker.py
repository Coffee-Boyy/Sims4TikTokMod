...
class DegreeTracker(SimInfoTracker):
    ...
    POST_GRADUATION_REWARDS = TunableTuple(description='\n        A tuple of the loots that will be awarded after graduation.\n        ', diploma_loot=TunableReference(description='\n            The diploma loot action applied to selectable sims. This loot will\n            also be applied when a graduated sim is added to the skewer. \n            ', manager=services.get_instance_manager(sims4.resources.Types.ACTION), class_restrictions=('LootActions',), pack_safe=True), portrait_loot=TunableReference(description='\n            The portrait loot action applied.\n            ', manager=services.get_instance_manager(sims4.resources.Types.ACTION), class_restrictions=('LootActions',), pack_safe=True), diploma_notification=UiDialogNotification.TunableFactory(description='\n            The notification to display when a selectable Sim receives their \n            diploma.\n            '))
