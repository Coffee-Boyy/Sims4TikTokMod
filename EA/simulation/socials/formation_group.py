...
class FormationSocialGroup(SocialGroup, RouteEventProviderMixin):
    ...
    def shutdown(self, finishing_type):
        ...
        if self.anchor:
            if self._state == FormationSocialGroupState.ROUTING and self.anchor.routing_component is not None:
