    ...
    def setup_asm_default(self, asm, *args, **kwargs):
        ...
        if locked_params:
            ...
            if asm.locked_params_log_enabled:
                param_context = LockedParamsContext(LockedParamCategory.JIG, str(self), 'From JigGroup with initiating sim ' + str(self.initiating_sim))
                locked_params_log = create_locked_params_log(locked_params, param_context)
            asm.update_locked_params(locked_params, locked_params_log=locked_params_log)
