...
class _ArbEventHandler:
    ...
    from _animation import CENSOREVENT_STATE_OFF, CENSOREVENT_STATE_TORSO, CENSOREVENT_STATE_TORSOPELVIS, CENSOREVENT_STATE_PELVIS, CENSOREVENT_STATE_FULLBODY, CENSOREVENT_STATE_RHAND, CENSOREVENT_STATE_LHAND, CENSOREVENT_STATE_TODDLERPELVIS, CENSOREVENT_STATE_FACE
except:
